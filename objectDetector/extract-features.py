...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', "--pospath", help="Path to positive images",
            default="../data/dataset/barcodeData/pos")
    parser.add_argument('-n', "--negpath", help="Path to negative images",
            default="../data/dataset/barcodeData/neg")
    ...
    if not os.path.exists(pos_im_path):
        raise ValueError("not exist pos_im_path:{}".format(pos_im_path))

    if not os.path.exists(neg_im_path):
        raise ValueError("not exist neg_im_path:{}".format(neg_im_path))
